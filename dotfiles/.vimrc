...
autocmd BufNewFile *.psgi 0r $HOME/.vim/template/perl-script.txt
autocmd BufNewFile *.cgi  0r $HOME/.vim/template/perl-script.txt
autocmd BufNewFile *.fcgi  0r $HOME/.vim/template/perl-script.txt
autocmd BufNewFile *.pm   0r $HOME/.vim/template/perl-script.txt

autocmd BufNewFile *.t  0r $HOME/.vim/template/perl-test.txt

nnoremap <silent> <Space>pt :%! perltidy -se<CR>
...
let g:syntastic_mode_map = {
      \  'mode': 'active',
      \ 'active_filetypes': ['ruby', 'javascript', 'coffee','perl'],
